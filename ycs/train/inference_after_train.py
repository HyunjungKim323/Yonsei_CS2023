...
def main():
    ...
    #checkpoint_path = path_mmseg+'/checkpoints/iter_110670.pth'
    checkpoint_path = './segformer_modelC/iter_110670.pth'
    ...
    for image_num in os.listdir(test_path):
        ...
        test_img_path = os.path.join(test_path, image_num)
