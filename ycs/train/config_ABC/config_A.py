...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file='splits_crop/train.txt'))
val_dataloader = dict(
    batch_size=1,
    num_workers=4,
    persistent_workers=True,
...
log_level = 'INFO'
load_from = './checkpoints/segformer_mit-b5_8xb1_1024x1024_160k_cityscapes_20211206_072934-87a052ec.pth'
resume = False
...
train_cfg = dict(type='IterBasedTrainLoop', max_iters=53550, val_interval=8925)
...
default_hooks = dict(
    ...
    checkpoint=dict(type='CheckpointHook', by_epoch=False, interval=8925),
    sampler_seed=dict(type='DistSamplerSeedHook'),
    visualization=dict(type='SegVisualizationHook', draw=True, interval=1))
checkpoint = 'https://download.openmmlab.com/mmsegmentation/v0.5/pretrain/segformer/mit_b5_20220624-658746d9.pth'
work_dir = './work_dirs/segformer_crop'
